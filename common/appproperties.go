...
import (
	...
	"github.com/zhangpy/unioffice/schema/soo/ofc/extended_properties"
)
...
func NewAppProperties() AppProperties {
	...
	p.SetApplication("github.com/zhangpy/unioffice")
	p.SetDocSecurity(0)
...
// For gooxml created documents, it defaults to github.com/zhangpy/unioffice
